...
\lstdefinelanguage{terminal}{
    ...
    keywords={python3.9,curl,source,sudo,pip,starknet,cd,git,cargo,nano,export},
    keywordstyle=\bf,
    breaklines=true,
    breakindent=40pt,
    literate={-}{-}1
...
\lstdefinelanguage{cairo}{
    ...
    morecomment=[l]{//},
    commentstyle=\color{darkgreen},
    keywords={struct, fn, let, if, else, mod},
    keywordstyle=\bf,
    breaklines=true,
    breakindent=40pt,
    literate={-}{-}1
...
\section{Problem statement} \label{subsection:problem_statement}
Loot boxes are a widely used reward mechanism used in videogames.
